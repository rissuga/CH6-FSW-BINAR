            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-6 ps-5" >
                        <img src={imageService} alt="services-img" width="85%"/>
                    </div>
                    <div className="col-lg-6 py-5" >
                        <div className="content">
                            ...
                            <ul className="text-list font__size__14" style={{ paddingLeft: '0px' }}>
                                <li className="mb-3 "><img src={iconService} alt="icon-check"/> &nbsp; Sewa Mobil Dengan Supir di Bali 12 Jam</li>
                                <li className="mb-3 "><img src={iconService} alt="icon-check"/> &nbsp; Sewa Mobil Lepas Kunci di Bali 24 Jam</li>
                                <li className="mb-3 "><img src={iconService} alt="icon-check"/> &nbsp; Sewa Mobil Jangka Panjang Bulanan</li>
                                <li className="mb-3 "><img src={iconService} alt="icon-check"/> &nbsp; Gratis Antar - Jemput Mobil di Bandara</li>
                                <li className="mb-3 "><img src={iconService} alt="icon-check"/> &nbsp; Layanan Airport Transfer / Drop In Out</li>
                            </ul>
                        </div>
                    </div>
                </div>
